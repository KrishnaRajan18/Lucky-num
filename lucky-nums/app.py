...
DEFAULT_URL = 'http://numbersapi.com'
...
def get_num_facts():
    ...
    # call API to get fact of lucky year
    year_fact = requests.get(f'{DEFAULT_URL}/{year}/year')
    year_text = year_fact.text

    # call API to get fact of lucky num
    num_fact = requests.get(f'{DEFAULT_URL}/{num}')
